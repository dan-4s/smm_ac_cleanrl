...
#SBATCH --array=0-119            # (4 LRs * 3 Freqs * 3 Ns * 10 Repeats) - 1
...
i_n=$(( (SLURM_ARRAY_TASK_ID / NUM_REPEATS) % 1 ))
i_freq=$(( (SLURM_ARRAY_TASK_ID / (NUM_REPEATS * 1)) % 3 ))
i_lr=$(( SLURM_ARRAY_TASK_ID / (NUM_REPEATS * 1 * 3) ))
